...
function WatchList({ user }) {
  ...
  const addToWatchList = (symbol) => {
    ...
    // hence, have to pass the function as a prop to WatchListSearch
  ...
  const deleteFromWatchList = (symbolToDelete) => {
    ...
    // don't copy the array first.. because we are not modifying it directly
    // are only using it to read from.. and newWatchList is the new updated array
